...
from data_utils import  Tokenizer4Bert, NaacalDataset
...
class Instructor(object):
    def __init__(self,opt):
        ...
        self.trainset = NaacalDataset(fname=self.opt.train_dir,tokenizer=tokenizer, opt=self.opt)
        self.valset = NaacalDataset(fname=self.opt.dev_dir, tokenizer=tokenizer, opt=self.opt)
        self.testset = NaacalDataset(fname=self.opt.test_dir,tokenizer=tokenizer, opt=self.opt)
    ...
    def dev_tradition(self):
        ...
        f1_ma = f1_score(all_labels, preds, labels=[0,1], average='macro')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default='twitter_testA_seenval', type=str,required=False)
    ...
    dataset_files = {
        'twitter_testA_seenval': {
            'train_dir': "./datasets/twitter_data_naacl/twitter_testA_seenval/train.csv",
            'dev_dir': "./datasets/twitter_data_naacl/twitter_testA_seenval/validation.csv",
            'test_dir': "./datasets/twitter_data_naacl/twitter_testA_seenval/test.csv",
        },
        'twitter_testCC_seenval': {
            'train_dir': "./datasets/twitter_data_naacl/twitter_testCC_seenval/train.csv",
            'dev_dir': "./datasets/twitter_data_naacl/twitter_testCC_seenval/validation.csv",
            'test_dir': "./datasets/twitter_data_naacl/twitter_testCC_seenval/test.csv",
        },
        'twitter_testDT_seenval': {
            'train_dir': "./datasets/twitter_data_naacl/twitter_testDT_seenval/train.csv",
            'dev_dir': "./datasets/twitter_data_naacl/twitter_testDT_seenval/validation.csv",
            'test_dir': "./datasets/twitter_data_naacl/twitter_testDT_seenval/test.csv",
        },
        'twitter_testFM_seenval': {
            'train_dir': "./datasets/twitter_data_naacl/twitter_testFM_seenval/train.csv",
            'dev_dir': "./datasets/twitter_data_naacl/twitter_testFM_seenval/validation.csv",
            'test_dir': "./datasets/twitter_data_naacl/twitter_testFM_seenval/test.csv",
        },
        'twitter_testHC_seenval': {
            'train_dir': "./datasets/twitter_data_naacl/twitter_testHC_seenval/train.csv",
            'dev_dir': "./datasets/twitter_data_naacl/twitter_testHC_seenval/validation.csv",
            'test_dir': "./datasets/twitter_data_naacl/twitter_testHC_seenval/test.csv",
        },
        'twitter_testLA_seenval': {
            'train_dir': "./datasets/twitter_data_naacl/twitter_testLA_seenval/train.csv",
            'dev_dir': "./datasets/twitter_data_naacl/twitter_testLA_seenval/validation.csv",
            'test_dir': "./datasets/twitter_data_naacl/twitter_testLA_seenval/test.csv",
        },
        'fewshot_semeval16': {
            "data_dir": "./datasets/fewshot_semeval16",
            'all_tasks': './datasets/fewshot_semeval16/total_tasks',
            'lens': "3:1:2",
            'cross_time': 4,
        },
        'fewshot_wtwt_3way': {
            "data_dir": "./datasets/fewshot_wtwt_3way",
            'all_tasks': './datasets/fewshot_wtwt_3way/total_tasks',
            'lens': "3:1:1",
            'cross_time': 4,
        },
        'fewshot_wtwt_4way': {
            "data_dir": "./datasets/fewshot_wtwt_4way",
            'all_tasks': './datasets/fewshot_wtwt_4way/total_tasks',
            'lens': "3:1:1",
            'cross_time': 4,
        },
    }
    ...
    opt.train_dir = opt.dataset_files['train_dir']
    opt.dev_dir = opt.dataset_files['dev_dir']
    opt.test_dir = opt.dataset_files['test_dir']
